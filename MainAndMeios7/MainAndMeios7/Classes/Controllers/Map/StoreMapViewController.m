...
- (void)viewDidLoad
{
    ...
    _coordinate = CLLocationCoordinate2DMake([[_storeInfo safeNumberObjectForKey:@"lat"] floatValue],
...
//            NSString* addr = [NSString stringWithFormat:@"http://maps.apple.com/maps?daddr=%1.6f,%1.6f&saddr=%1.6f,%1.6f",communityPoint.coordinate.latitude,communityPoint.coordinate.longitude,mapView.userLocation.coordinate.latitude,mapView.userLocation.coordinate.longitude];
            ...
            NSString* addr = [NSString stringWithFormat:@"http://maps.apple.com/maps?daddr=%1.6f,%1.6f&saddr=%1.6f,%1.6f",communityPoint.coordinate.latitude,communityPoint.coordinate.longitude,[LocationManager sharedManager].currentLocation.coordinate.latitude,[LocationManager sharedManager].currentLocation.coordinate.longitude];
