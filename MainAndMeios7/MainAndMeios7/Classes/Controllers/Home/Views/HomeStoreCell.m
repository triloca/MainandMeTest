...
@interface HomeStoreCell ()


@end

@implementation HomeStoreCell
...
- (void)setStoreDict:(NSDictionary *)storeDict{
    ...
    NSDictionary* userDict = [storeDict safeDictionaryObjectForKey:@"user"];
    
    _userNameLabel.text = [userDict safeStringObjectForKey:@"name"];
    
    NSString* userAvatarURLString = [userDict safeStringObjectForKey:@"avatar_url"];
    
    [self setUserImageURLString:userAvatarURLString];
