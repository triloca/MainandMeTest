...
- (void)setCellData:(NSDictionary *)cellData{
    ...
    _descriptionLabel.text = [cellData safeStringObjectForKey:@"street"];
    _likesLabel.text = [[cellData safeNumberObjectForKey:@"like_count"] stringValue];
    _followersLabel.text = [[cellData safeNumberObjectForKey:@"follower_count"] stringValue];
    _rateLabel.text = [[cellData safeNumberObjectForKey:@"rate"] stringValue];
    _productsLabel.text = [[cellData safeNumberObjectForKey:@"products_count"] stringValue];
    
    BOOL is_following = [[cellData safeNumberObjectForKey:@"is_following"] boolValue];
    
    if (is_following) {
        _followImageView.hidden = NO;
    }else{
