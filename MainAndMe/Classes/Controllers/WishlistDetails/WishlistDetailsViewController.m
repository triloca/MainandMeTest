//
//  WishlistDetailsViewController.m
//  MainAndMe
//
...
@implementation WishlistDetailsViewController
...
- (void)loadWishlistInfo{
    [MBProgressHUD showHUDAddedTo:self.view animated:YES];
    [SearchManager loadWishlistById:[[_wishlistInfo safeNumberObjectForKey:@"id"] stringValue]
